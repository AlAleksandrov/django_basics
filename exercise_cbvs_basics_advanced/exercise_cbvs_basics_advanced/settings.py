"""
Django settings for a exercise_cbvs_basics_advanced project.
...
ROOT_URLCONF = 'exercise_cbvs_basics_advanced.urls'
...
WSGI_APPLICATION = 'exercise_cbvs_basics_advanced.wsgi.application'
